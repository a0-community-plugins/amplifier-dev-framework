# Amplifier CLI Installation Architecture and Development Hygiene

Guidelines for how the Amplifier CLI installation works and the correct patterns for development work.
...
3. It cannot even download modules to repopulate because it needs modules to do that
...
### Do Not Modify ~/.amplifier/cache/ for Development
...
- Using cache paths in your work (they are ephemeral)
...
To test local changes without modifying the global installation, create `.amplifier/settings.yaml` in your project:
...
- Easy to recreate
- Changes do not affect the installed CLI

## Summary: Where Things Belong

| What | Where | Why |
|------|-------|-----|
| Code you are modifying | Cloned repo or submodule | Git-tracked, pushable |
...
| Installed CLI runtime | `~/.amplifier/cache/` | Auto-managed, do not touch |
